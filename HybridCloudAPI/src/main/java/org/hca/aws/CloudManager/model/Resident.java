...
public class Resident {
    ...
    private Date lastFall;
    private Date lastErVisit;
    ...
    public Date getLastFall() {
        return lastFall;
    }

    public void setLastFall(Date lastFall) {
        this.lastFall = lastFall;
    }

    public Date getLastErVisit() {
        return lastErVisit;
    }

    public void setLastErVisit(Date lastErVisit) {
